...
function wg_styles() {
    ...
    wp_register_style( 'css-normalize-substrate-system', $theme_dir . '/assets/css/css-normalize.min.css', array(), '12.2025' ); 
    wp_register_style( 'utilities', $theme_dir . '/assets/css/utilities.min.css', array(), '1.1' );
